...
module OldAWS
  module S3
    ...
    Base.class_eval do
      include OldAWS::S3::Connection::Management
    end

    Bucket.class_eval do
      include OldAWS::S3::Logging::Management
      include OldAWS::S3::ACL::Bucket
    end

    S3Object.class_eval do
      include OldAWS::S3::ACL::S3Object
      include OldAWS::S3::BitTorrent
    end
  end
end
